...
- **Liquidez Corrente**: Capacidade de pagamento de obrigações de curto prazo
  
  $$
  \text{Liquidez Corrente} = \frac{\text{Ativo Circulante}}{\text{Passivo Circulante}}
  $$

- **Liquidez Seca**: Capacidade de pagamento excluindo estoques
  
  $$
  \text{Liquidez Seca} = \frac{\text{Ativo Circulante} - \text{Estoques}}{\text{Passivo Circulante}}
  $$

- **Liquidez Imediata**: Capacidade de pagamento utilizando apenas recursos de alta liquidez
